import React, { Button, Component, Fragment } from 'react';
...
export default class Game extends Component {
	...
	constructor(props) {
		super(props);
		this.supplyCenters = ['Ankara', 'Belgium', 'Berlin', 'Brest', 'Budapest', 'Bulgaria',	'Constantinople',
	...
	buildString(territory, event){
		...
		const country = territory.getAttribute('country') != '' ? ('Country: ' + territory.getAttribute('country') + '<br/>') : '';
		const unit = territory.getAttribute('unit') != '' ? ('Unit: ' + territory.getAttribute('unit') + '<br/>') : '';
		const player = territory.getAttribute('player') != '' ? ('Player: ' + territory.getAttribute('player') + '<br/>') : '';
