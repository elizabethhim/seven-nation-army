            ...
            <ul className="list" data-component="People_List">
              ...
              <li className="clearfix">
                ...
                <div className="about">
                  ...
                  <div className="status">
                    <i className="fa fa-circle offline" /> left 7 mins <br />{' '}
                    ago
                  </div>
                </div>
              </li>
              ...
              <li className="clearfix">
                ...
                <div className="about">
                  ...
                  <div className="status">
                    <i className="fa fa-circle offline" /> left 30 mins <br />
                    ago
                  </div>
                </div>
              </li>
              ...
              <ul>
                <li className="clearfix">
                  ...
                  <div className="message other-message float-right">
                    Hi Vincent... Let's team up against Germany! What do you
                    think?
                  </div>
                </li>
                ...
                <li>
                  ...
                  <div className="message my-message">
                    Oh my god. Yes! Next turn, I'll use my army to attack
                    Munich. Can you support me?
                  </div>
                </li>
