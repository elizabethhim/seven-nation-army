    ...
    render() {
        ...
        return (
            <div>
                ...
                <i className="far fa-window-minimize" id="maximize-chat-button" onClick={this.maximize}></i>
                <h1>Chat</h1>
                </div>
                
                <div className="container clearfix">
                    <div className="people-list" id="people-list">
                    <i className="far fa-window-minimize" id="minimize-chat-button" onClick={this.minimize}></i>
