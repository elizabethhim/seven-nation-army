...
export function resetFill(territories) {
   for (let i = 0; i < territories.length; i++) {
      let opacity =
         territories[i].getAttribute("countrycolor") === "yellow" ? 0 : 0.15;
...
export function findSupportSpaces(territory) {
   ...
   setFill([validSupportSpaces, "green", 0.15]);
...
export function drawArrow(origin, dest, actionId) {
   //delete arrow if already exists
   ...
   let points = [midPoint[0] + radius, midPoint[1] - radius, midPoint[0] - radius, midPoint[1] + radius];
...
export const countriesJSON = {
   Austria_Hungary: {
      ...
      supplyCenters: ["Budapest", "Trieste", "Vienna"]
   },
   England: {
      color: "#605aa7",
      player: "",
      ...
      supplyCenters: ["Edinburgh", "Liverpool", "London"]
   },
   France: {
      color: "#9a9148",
      player: "",
      ...
      supplyCenters: ["Brest", "Marseilles", "Paris"]
   },
   Germany: {
      color: "#c0495e",
      player: "",
      ...
      supplyCenters: ["Berlin", "Kiel", "Munich"]
   },
   Italy: {
      color: "#cb75db",
      player: "",
      ...
      supplyCenters: ["Naples", "Rome", "Venice"]
   },
   Russia: {
      color: "#c95df6",
      player: "",
      ...
      supplyCenters: ["Moscow", "Sevestopol", "St_Petersburg", "Warsaw"]
   },
   Turkey: {
      color: "#7b69b8",
      player: "",
      ...
      supplyCenters: ["Ankara", "Constantinople", "Smyrna"]
   }
};
